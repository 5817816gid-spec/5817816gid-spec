...
> 🧩 *"Если бага нет — я всё равно его найду."*

Меня зовут Александра, я — QA-Инженер, который любит, когда всё работает идеально   
Тестирую, автоматизирую, анализирую — и помогаю командам выпускать стабильные, качественные продукты.
---

## 🚀 Немного обо мне

🎯 Более 3 лет в тестировании веб и мобильных приложений  
🧠 Люблю разбираться в сложных системах и логике взаимодействия API  
🔍 Могу найти баг даже в калькуляторе — проверено временем    
...
📧 Email: [alromanovaaa@yandex.ru](mailto:твоя_почта@example.com)  
💬 Telegram: [@al_rommm](https://t.me/твой_ник)  
---

## ⚡️ Немного личного

💡 Люблю, когда баг репорт написан идеально.  
💻 Не боюсь лезть в логи, код и базы данных.  
🎯 Верю, что идеальный продукт — результат качественного тестирования.  

---

⭐️ *Тестирование — это не просто найти ошибку. Это сделать продукт надёжнее, а пользователя — счастливее.*
